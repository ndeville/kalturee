...
def convert_pptx_to_pdf(pptx_path):
    ...
    # Generate output path with same name but pdf extension
...
def upload_ppt_to_kaltura(file_path, channel_id=None, demo_mode=False, ppt_thumbnail_path=None, title_text=None, subtitle_text=None, MY_USER_SECRET=None, MY_ADMIN_SECRET=None, MY_PARTNER_ID=None): 
    ...
    #     print(f"Converting PPTX to PDF for upload...")
    ...
    # ✅ TITLE
    if not demo_mode:
        powerpoint_title = generate_title_from_ppt_filename(file_path)
        document_entry.name = powerpoint_title
    else:
        powerpoint_title = title_text
        document_entry.name = powerpoint_title # Generated by AI and passed as argument
    # Remove any quotes at the beginning and end of title
    if document_entry.name:
        document_entry.name = document_entry.name.strip('"\'')
    print(f"\t> Title: {document_entry.name}")
    ...
    print(f"\t> Description: {document_entry.description}")
    ...
    # ✅ THUMBNAIL
    if not demo_mode:
        # Use original PPTX file for thumbnail generation
...
if __name__ == "__main__":
    ...
    upload_ppt_to_kaltura(file_path, channel_id=channel_id, MY_USER_SECRET=USER_SECRET, MY_ADMIN_SECRET=ADMIN_SECRET, MY_PARTNER_ID=PARTNER_ID)
