...
from PPTX.cleanup_pptx import clean_pptx
...
def get_latest_pptx_file(folder_path):
    ...
    for root, dirs, files in os.walk(folder_path):
        for file in files:
            if file.endswith('.pptx') and "_light" not in file:
...
if not latest_pptx:
    ...
    print(f"\n✅ Processing latest .pptx file: {latest_pptx}\n")

# Optimize the PPTX file
latest_pptx = clean_pptx(latest_pptx)
